...
public class CrmTest {
    ...
    void createNewProject() {
        ...
        assertThat(driver.findElement(By.xpath("//span[@class='validation-failed']")),
                hasText("Это значение уже используется."));
    }
    ...
    void createNewContactPerson() {
        ...
        assertThat(driver.findElement(By.xpath("//div[@class='flash-messages-holder']/div/div[@class='message']")),
                hasText("Контактное лицо сохранено"));
